...
export function HomePage({ cart, setCart, notify, theme, toggleTheme }) {
  ...
  const [showLeon, setShowLeon] = useState(false);

  const { savedGames, addToWishlist, removeFromWishlist } = useWishlistStore();
      ...
      <div className="home-page">
        ...
        <div className="products-grid">
          {visibleProducts.map((product) => {
            const isSaved = savedGames.some((g) => g.id === product.id);
